...
@section('content')
    <section class="content">
        <div class="container-fluid">
            @if ($o_modulo::canMod('marcas', 'crear'))
                <div class="row clearfix">
                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6 botones">
                        <a href="{{ route('marcas.create') }}" class="btn btn-primary"><i
                                class="material-icons">add</i><span>Nueva marca</span></a>
                    </div>
                </div>
            @endif
            <!-- Basic Examples -->
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <input type="text" name="url_lista" id="url_lista" value="{{ route('marcas.index') }}"
                                hidden>
                                    ...
                                    <tbody id="datos_lista">
                                        @foreach ($marcas as $key => $marca)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($o_modulo::canMod('marcas', 'eliminar'))
                                                        <input type="text" name="eliminar" class="url_eliminar"
                                                            value="{{ route('marcas.destroy', $marca->id) }}" hidden>
                                                        <a href="#" title="Eliminar" class="eliminar"><i
                                                                class="material-icons eliminar">delete</i>
                                                        </a>
                                                    @endif
                                                    @if ($o_modulo::canMod('marcas', 'editar'))
                                                        <a href="{{ route('marcas.edit', $marca->id) }}" title="Editar"><i
