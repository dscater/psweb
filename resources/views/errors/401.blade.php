...
@section('css')
    ...
    <link href="{{ asset('AdminBSBMaterialDesign-master/plugins/bootstrap-select/css/bootstrap-select.css') }}"
        rel="stylesheet" />
                        ...
                        <div class="body">
                            <div class="five-zero-zero-container">
                                ...
                                <div class="error-message">
                                    <h4>USTED NO TIENE PERMISO PARA VER ESTA PÁGINA</h4>
                                </div>
                                <div class="button-place">
                                    <a href="{{ route('home') }}" class="btn btn-default btn-lg waves-effect">VOLVER AL
                                        INICIO</a>
                                </div>
                            </div>
                        </div>
