            ...
            <div class="row clearfix">
                @if ($o_modulo::canMod('tipo_ingreso_salida', 'crear'))
                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6 botones">
                        <a href="{{ route('tipo_ingreso_salida.create') }}" class="btn bg-deep-purple waves-effect"><i
                                class="material-icons">add</i><span>Nuevo tipo</span></a>
                    </div>
                @endif
                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6 botones">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                LISTA DE TIPOS DE INGRESO/SALIDA
                            </h2>
                        </div>
                        <div class="body">
                            <input type="text" name="url_lista" id="url_lista"
                                value="{{ route('tipo_ingreso_salida.index') }}" hidden>
                                    ...
                                    <tbody id="datos_lista">
                                        @foreach ($tipo_ingreso_salida as $key => $tipo)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($o_modulo::canMod('tipo_ingreso_salida', 'eliminar'))
                                                        <input type="text" name="eliminar" class="url_eliminar"
                                                            value="{{ route('tipo_ingreso_salida.destroy', $tipo->id) }}"
                                                            hidden>
                                                        <a href="#" title="Eliminar" class="eliminar"><i
                                                                class="material-icons eliminar">delete</i>
                                                        </a>
                                                    @endif
                                                    @if ($o_modulo::canMod('tipo_ingreso_salida', 'editar'))
                                                        <a href="{{ route('tipo_ingreso_salida.edit', $tipo->id) }}"
