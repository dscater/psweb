...
@section('content')
    <input type="text" value="{{ route('salidas.obtieneStock') }}" id="url_stock" hidden>
    <input type="text" value="{{ route('salidas.store') }}" id="url_store" hidden>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            {!! Form::open(['route' => 'salidas.store', 'method' => 'post', 'files' => 'true', 'id' => 'form_validation']) !!}
                            @include('salidas.forms.form')
                            <button class="btn btn-primary btn-lg waves-effect" type="submit" id="registra"><i
                                    class="material-icons">save</i><span>REGISTRAR</span></button>
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/registra_salida.js') }}"></script>
