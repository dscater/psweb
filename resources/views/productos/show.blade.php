                        ...
                        <div class="body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            {{ Form::text('cod_unico', null, ['class' => 'form-control', 'readonly', 'required']) }}
                            ...
                            <div class="row">
                                ...
                                @if (isset($producto))
                                    <div class="col-md-4 contenedor_foto">
                                        <img src="{{ asset('imgs/productos/' . $producto->imagen) }}" width="150"
                                            height="155" id="imagen_select">
                                    </div>
                                @else
                                    <div class="col-md-4 contenedor_foto">
                                        <img src="{{ asset('imgs/productos/producto_default.png') }}" width="150"
                                            height="155" id="imagen_select">
                                    </div>
                                @endif
                            </div>
                            ...
                            <a href="{{ route('productos.index') }}" class="btn btn-primary btn-lg waves-effect"
                                type="submit"><i class="material-icons">check</i><span>Aceptar</span></a>
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
