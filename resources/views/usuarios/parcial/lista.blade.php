...
<tr>
    ...
    <td>
        <input type="text" name="eliminar" class="url_eliminar" value="{{ route('usuarios.destroy',$user->user_id) }}" hidden>
        <a href="#" title="Eliminar" class="eliminar"><i class="material-icons eliminar">delete</i>
        </a>
        <a href="{{ route('usuarios.edit',$user->datos_id) }}" title="Editar"><i class="material-icons editar">edit</i>
        </a>
