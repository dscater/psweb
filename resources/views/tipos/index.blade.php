...
@section('content')
    <section class="content">
        <div class="container-fluid">
            @if ($o_modulo::canMod('tipos', 'crear'))
                <div class="row clearfix">
                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6 botones">
                        <a href="{{ route('tipos.create') }}" class="btn btn-primary"><i
                                    ...
                                    <tbody id="datos_lista">
                                        @foreach ($tipos as $key => $tipo)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($o_modulo::canMod('tipos', 'eliminar'))
                                                        <input type="text" name="eliminar" class="url_eliminar"
                                                            value="{{ route('tipos.destroy', $tipo->id) }}" hidden>
                                                        <a href="#" title="Eliminar" class="eliminar"><i
                                                                class="material-icons eliminar">delete</i>
                                                        </a>
                                                    @endif
                                                    @if ($o_modulo::canMod('tipos', 'editar'))
                                                        <a href="{{ route('tipos.edit', $tipo->id) }}" title="Editar"><i
