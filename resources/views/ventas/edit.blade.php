...
.factura tbody tr.descuento td{
}

.factura tbody tr.descuento td:nth-child(4n),tr.descuento td:nth-child(5n){
    border: solid 1px #c0c0c0;
}

.factura tbody tr.total_final td:nth-child(4n), tr.total_final td:nth-child(5n){
    background:#0080ff;
    color:white;
}
.info1{
                            ...
                            <div class="col-md-12">
                                <div class="datos_factura">
                                    <div class="facturar_a">
                                        ...
                                        <label class="inform"><strong>A nombre de: </strong></label>
                                        {{Form::text('nom_cli',$venta->cliente->nom_cli,['class'=>'text'])}}
                                        <br>
                                        <label class="inform"><strong>NIT/C.I.: </strong></label>
                                        {{Form::text('nit_ci',$venta->cliente->nit_ci,['class'=>'text'])}}
                                        <p><button type="submit" class="btn btn-primary"><i class="material-icons">autorenew</i><span>Actualizar</span></button></p>
                                        {!!Form::close()!!}
                                    </div>
                                    <div class="num_fac">
                            ...
                            <div class="col-md-12">
                                <table class="factura">
                                    ...
                                    <tbody>
                                        ...
                                        @php
                                            $descuento = DB::select("SELECT descuento 
                                                                    FROM descuentos 
                                                                    WHERE simbolo = '$value->descuento_sim'")[0];    
                                            $v_d = $descuento->descuento * 100;
                                            $v_d = $v_d."%";
                                        @endphp
                                            <tr>
                                                <td>{{$cont++}}</td>
...
<script type="text/javascript">
    @if(session('success'))
    showNotification('alert-success', 'ACTUALIZACIÓN ÉXITOSA. ','top', 'right', 'animated bounceInRight', 'animated bounceOutRight');
