...
class Producto extends Model
{
    ...
    {
        return DB::select("SELECT p.id, p.cod,p.cod_unico,p.nom,p.precio,p.descripcion,p.imagen,t.nom as tipo,m.nom as marca,md.simbolo as medida,s.cant_actual,s.cant_min, pv.razon_social_p
                        FROM productos p
    ...
    {
        return DB::select("SELECT nom,cod_unico, imagen, precio 
                        FROM productos 
                        WHERE id = $producto");
    }
}
